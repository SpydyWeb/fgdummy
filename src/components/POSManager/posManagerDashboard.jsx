...
// import {  Spin, message,Row,Col,Form,DatePicker, Button,Input,Table, Space,Card,Select } from "antd";
...
const PosManagerDashboard = (props) => {
  ...
  const statusLU = [
    ...
    const failedReasonLU = [
      { label: 'Bank De-dupe', value: 'bankdedupe' },
    ...
    },
{
  ...
  key: '',
    ...
    {
      title: "POS User Name",
      dataIndex: "posUserName",
      key: '',
    },
    {
        title: "Total Ageing",
        dataIndex: "totalAgeing",
        key: '',
      },
      {
        title: "Queue Ageing",
        dataIndex: "queueAgeing",
        key: '',
      },
  ];
  useEffect(() => {
...
<Row justify="start" style={{ padding: '0 32px', marginBottom: '16px' }}>
        <Col>
          <h5 style={{ fontWeight: 'bold', fontSize: '20px' }}>Pending SR</h5>
        </Col>
      </Row>

      {/* TAT Boxes */}
      <Row justify="space-evenly" align="middle" gutter={[24, 24]} style={{ padding: '0 32px' }}>
        {/* Box 1 - Within TAT */}
        <Col xs={24} sm={12} md={12} lg={6} xl={6}>
          <div className="dashboard-box" style={{ minWidth: '450px', height: '150px', marginBottom: '20px', marginLeft: '-100px' }}>
            <p className="dashboard-paragraph1">
              Within TAT: <span className="new-ticket-count">{isTatData?.dashboardSummaries?.[0]?.withinTat ?? 'XX'}</span>
            </p>
          </div>
        </Col>
        ...
        {/* Box 2 - Beyond TAT */}
        <Col xs={24} sm={12} md={12} lg={6} xl={6}>
          <div className="dashboard-box" style={{ minWidth: '450px', height: '150px', marginBottom: '20px', marginRight: '80px' }}>
            <p className="dashboard-paragraph1">
              Beyond TAT: <span className="new-ticket-count">{isTatData?.dashboardSummaries?.[0]?.beyondTat ?? 'XX'}</span>
            </p>
          </div>
        </Col>
      </Row>

      {/* Service Requests & Advance Search */}
      <Row justify="space-between" align="middle" style={{ padding: '0 32px', marginTop: '12px' }}>
        {/* Left: Service Requests label */}
        <Col>
          <span style={{ fontSize: '16px', fontWeight: '600', color: '#b21f1f' }}>
            Service Requests
          </span>
        </Col>

        {/* Right: Advance Search button */}
       <Col>
  ...
  className="primary-btn"
  style={{ marginRight: 8 }}
  onClick={() => navigate("/blacklisted-policy")}
>
  Blacklisted Policy
</Button>
