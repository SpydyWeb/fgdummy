...
const PosApproveComponent = () => {
  ...
  const loggedUserId = loggedUser.userName;
  const loggedRole = loggedUser.role;
const approverList =[
  {userId: loggedUserId, role: 6, value:'posapprover1'},
  {userId:loggedUserId, role: 7, value:'posapprover2'},
  {userId: loggedUserId, role: 8, value:'posapprover3'},
  {userId: loggedUserId, role: 9, value:'posapprover4'}
]
