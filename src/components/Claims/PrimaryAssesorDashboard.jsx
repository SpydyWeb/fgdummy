...
const PrimaryAssesorDashboard = (props) => {
  ...
  const columns = [
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          <a>
            {" "}
            <i onClick={() => handleAction(record)} className="gridLink">
              {record?.serviceNo}
            </i>
          </a>
        </Space>
    ...
    },
    {
      ...
      dataIndex: "claimCategory",
      key: "claimCategory",
    },
    { title: "LA Name", dataIndex: "laName", key: "laName" },
    {
      title: "Beneficiary Name",
      dataIndex: "beneficaryName",
      key: "beneficaryName",
    },
        ...
        <Row gutter={16} style={{ marginBottom: "20px" }}>
          <Col span={4}>
            <Card bordered={true} style={{ textAlign: "center" }}>
              ...
              <br />
              <Text style={{ color: "#c21b17", fontSize: "20px" }}>
                {claimsDashboardData?.notificationDeath}
              </Text>
            </Card>
          </Col>
          <Col span={4}>
            <Card bordered={true} style={{ textAlign: "center" }}>
              ...
              <br />
              <Text style={{ color: "#c21b17", fontSize: "20px" }}>
                {claimsDashboardData?.notificationCritIll}
              </Text>
            </Card>
          </Col>
          <Col span={4}>
            <Card bordered={true} style={{ textAlign: "center" }}>
              ...
              <br />
              <Text style={{ color: "#c21b17", fontSize: "20px" }}>
                {claimsDashboardData?.notificationWoP}
              </Text>
            </Card>
          </Col>
          <Col span={4}>
            <Card bordered={true} style={{ textAlign: "center" }}>
              ...
              <br />
              <Text style={{ color: "#c21b17", fontSize: "20px" }}>
                {claimsDashboardData?.notificationTPD}
              </Text>
            </Card>
          </Col>
          <Col span={4}>
...
export default PrimaryAssesorDashboard;
