...
const POSApproverDashboard = (props) => {
...
// Replace the existing performClientSideFiltering function
    ...
    <>
      <div className="main-start">
        <div className="w-94">
          ...
          <h6 className="advance-title text-center">POS Approver Dashboard 1</h6>
            {/* <p>
            <Button
                  type="primary"
