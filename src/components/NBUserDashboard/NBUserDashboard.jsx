...
import {  Spin, message,Row,Col,Form,DatePicker, Button,Input,Checkbox,Table, Space,Card,Select,  Modal, Tooltip } from "antd";
...
let count = countData && countData.reduce((acc, obj) => {
 ...
 const renderTableData = () => {
  ...
  const searchData =async () => {    
   ...
   const response=await apiCalls.getRoleBasedSearchDetails(obj,"nb");
    ...
    <>
      <div className="main-start">
        <div className="w-94">
          ...
          <h6 className="advance-title text-center">NB User Dashboard</h6>
            {/* <p>
            <Button
                  type="primary"
