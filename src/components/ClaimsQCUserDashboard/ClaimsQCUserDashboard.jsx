...
const ClaimsQCUserDashboard = (props) => {
...
const columns = [
  //{ title: 'Ticket ID', dataIndex: 'serviceNo', key: 'serviceNo' },
  {
    title: "Ticket ID",
    dataIndex: "serviceNo",
    key: 'serviceNo',
...
<a> <i  onClick={() => handleAction(record)} className="gridLink">{record?.serviceNo}</i></a>
  ...
  },
  {
   ...
   render: (_, record) => (
    <Space size="middle">
    { moment.utc(record.date).local().format("DD/MM/YYYY")}
    </Space>
  ),
  },
  { title: 'Policy No', dataIndex: 'policyNo', key: 'policyNo' },
  { title: 'Notification Type', dataIndex: 'notificationType', key: 'notificationType' },
      ...
      <Row gutter={16} style={{ marginBottom: '20px' }}>
        <Col span={4}>
          <Card bordered={true} style={{ textAlign: 'center' }}>
            <Text strong>Notification Death</Text>
            <br />
        ...
        <Col span={4}>
          <Card bordered={true} style={{ textAlign: 'center' }}>
            <Text strong>Notification CI</Text>
            <br />
        ...
        <Col span={4}>
          <Card bordered={true} style={{ textAlign: 'center' }}>
            <Text strong>Notification WOP</Text>
            <br />
        ...
        <Col span={4}>
          <Card bordered={true} style={{ textAlign: 'center' }}>
            <Text strong>Notification TPD</Text>
            <br />
         ...
         <Col span={4}>
          <Card bordered={true} style={{ textAlign: 'center' }}>
            <Text strong>Notification Health</Text>
            <br />
            <Text style={{ color: '#c21b17', fontSize: '20px' }}>{claimsDashboardData?.notificationTPD}</Text>
          </Card>
        </Col>
    ...
    <Col className="m-10" xs={24} sm={24} md={24} lg={24} xxl={24}>
      ...
      <Col className="m-10" xs={24} sm={24} md={24} lg={24} xxl={24}>
                <Form.Item
                  ...
                  className="inputs-label mb-0 subtype right-colsize"
                >
                  <Input type="text" placeholder="Ticket ID No" className="cust-input modal-input"/>
                </Form.Item>
              </Col>
...
export default ClaimsQCUserDashboard;