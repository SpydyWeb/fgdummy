            ...
            <div className="main-start">
                <div className="w-94">
                        ...
                        <Col xs={24} sm={24} md={12} lg={6} xxl={6}>
                            ...
                            <table className="table table-bodered h-100">
                                ...
                                <tbody>
                                    ...
                                    <tr style={{ backgroundColor: '#f0f0f0' }}>
                                        <td className="p-24">Pending For Approval</td>
                                        <td className="p-24 text-red">XX</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <Col xs={24} sm={24} md={12} lg={6} xxl={6}>
                            <table className="table table-bodered h-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="p-24">Requirements Waived</td>
                                        <td className="p-24 text-red">XX</td>
                                    </tr>
                                    <tr style={{ backgroundColor: '#f0f0f0' }}>
                                        <td className="p-24">Total Requirements</td>
                                        <td className="p-24 text-red">XX</td>
                                    </tr>
                    ...
                    <p className="text-red">
                        <b style={{ cursor: "pointer", textDecoration: "underline" }} onClick={handleSelectAll}>Select All</b>
                        <b className="ms-4">Assign To</b>
                        ...
                        <Col className="m-10" xs={24} sm={24} md={24} lg={24} xxl={24}>
                            ...
                            >
                                <Select
                                    ...
                                    className="cust-input calltype-select"
                                    maxLength={100}
                                    placeholder="Select STP Fail Reason"
                                ></Select>
