...
const EmailManagementAdmin = () => {
  ...
  const [EmailManagementDashBoardData, setEmailManagementDashBoardData] =
    useState([]);
                        ...
                        <table className="table table-bordered">
                          <thead>
                            <tr>
                              <th>New Emails</th>
                              <th>
                                {UnAttendedMailsWithinTAT +
                                  UnAttendedMailsOutsideTAT}
                              </th>
                            </tr>
                          </thead>
                          <tbody>
                        ...
                        <table className="table table-bordered">
                          <thead>
                            <tr>
                              <th>Open Mails</th>
                              <th>
                                {OpenCasesWithinTAT + OpenCasesOutsideTAT}
                              </th>
                            </tr>
                          </thead>
                          <tbody>
                        ...
                        <table className="table table-bordered">
                          <thead>
                            <tr>
                              <th>Closed Emails</th>
                              <th>
                                {ClosedCasesWithinTAT + ClosedCasesOutsideTAT}
                              </th>
                            </tr>
                          </thead>
                          <tbody>
                          ...
                          <Form.Item name="filterUser" label="User Name">
                            <Select
                              ...
                              onChange={(value) => {
                                ...
                                TATCasesForEmailMng(value || null);
                              }}
                            />
                          </Form.Item>
                        </Col>
